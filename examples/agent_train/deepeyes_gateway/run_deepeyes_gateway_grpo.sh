...
python3 -m verl.trainer.main_ppo_sync \
  ...
  actor_rollout_ref.rollout.custom.agent_framework.agent_runners.deepeyes.tool_config_path="${CONFIG_DIR}/image_zoom_in_tool_config.yaml" \
  actor_rollout_ref.rollout.custom.agent_framework.agent_runners.deepeyes.runner_kwargs.max_turns=5
